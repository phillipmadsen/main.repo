				...
				<div class="container clearfix">
					...
					<div class="col-md-8 nopadding">
						...
						<div class="col-md-6 noleftpadding bottommargin-sm">
							<a href="#"><img src="{!! asset('/frontend/images/shop/banners/2.jpg') !!}" alt="Image"></a>
						</div>

						<div class="col-md-6 noleftpadding bottommargin-sm">
							<a href="#"><img src="{!! asset('/frontend/images/shop/banners/8.jpg') !!}" alt="Image"></a>
						</div>

						<div class="clear"></div>

						<div class="col-md-12 noleftpadding">
							<a href="#"><img src="{!! asset('/frontend/images/shop/banners/4.jpg') !!}" alt="Image"></a>
						</div>

					</div>

					<div class="col-md-4 nopadding">
						<a href="#"><img src="{!! asset('/frontend/images/shop/banners/9.jpg') !!}" alt="Image"></a>
					</div>
					...
					<div class="tabs topmargin-lg clearfix" id="tab-3">
						...
						<div class="tab-container">
							...
							<div class="tab-content clearfix" id="tabs-11">
								...
								add product loop here

					@include('frontend.shop.partials.layout.loop.ploop')
					...
					<div class="col_one_third">
						...
						<form id="widget-subscribe-form2" action="{!! asset('/frontend/include/subscribe.php') !!}" role="form" method="post" class="nobottommargin">
					...
					<ul class="clients-grid grid-6 nobottommargin clearfix">
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/1.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/2.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/3.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/4.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/5.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/6.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/7.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/8.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/9.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/10.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/11.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/12.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/13.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/14.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/15.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/16.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/19.png') !!}" alt="Clients"></a></li>
						<li><a href="#"><img src="{!! asset('/frontend/images/clients/logo/18.png') !!}" alt="Clients"></a></li>
					</ul>
				...
				<div class="section notopborder nobottomborder nomargin nopadding nobg footer-stick">
					<div class="container clearfix">
						...
						<div class="col_half nobottommargin topmargin">
							<img src="{!! asset('/frontend/images/services/4.jpg') !!}" alt="Image" class="nobottommargin">
						</div>
						...
						<div class="col_half nobottommargin col_last">
							...
							<form id="widget-subscribe-form3" action="{!! asset('/frontend/include/subscribe.php') !!}" role="form" method="post" class="nobottommargin">
